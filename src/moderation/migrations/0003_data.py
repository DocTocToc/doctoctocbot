...
user_id_list = [
        ...
        894923722557206529, # @doctoctocbot2 'moderator'
...
categories = [
    ...
    ['nurse', 'Nurse', 'IDE'],
    ['anp', 'Advanced nurse practitioner', 'Infirmier de pratique avancée'],
    ['slp', 'Speech-language pathologist', 'Orthophoniste'],
    ['physical_therapist', 'Physical therapist', 'Kinésithérapeute'],
    ['medical_student', 'Medical students', 'Étudiants en médecine'],
...
def create_usercategoryrelationship_instances(apps, schema_editor):
    ...
    soc_med_obj = SocialMedia.objects.get(name = 'twitter')
    
    mod_cat_obj = Category.objects.get(name='moderator')
    spam_cat_obj = Category.objects.get(name='spam')
    midwife_cat_obj = Category.objects.get(name='midwife')
    patient_cat_obj = Category.objects.get(name='patient')
    physician_cat_obj = Category.objects.get(name='physician')
    pharmacist_cat_obj = Category.objects.get(name='pharmacist')

    #894923722557206529 @doctoctocbot2 'moderator'
    social_user_obj = SocialUser.objects.create(user_id = 894923722557206529, social_media = soc_med_obj)
    moderator = SocialUser.objects.get(user_id = 894923722557206529)
    user_category_relationship = UserCategoryRelationship.objects.create(social_user = social_user_obj, category = mod_cat_obj, moderator = social_user_obj)
    ...
    # 762321963402596352 @freehealthio 'midwife'
    social_user_obj = SocialUser.objects.create(user_id = 762321963402596352, social_media = soc_med_obj)
    user_category_relationship = UserCategoryRelationship(
        social_user = social_user_obj,
    ...
    # 2567917734, @librehealthcare 'patient'
    social_user_obj = SocialUser.objects.create(user_id = 2567917734, social_media = soc_med_obj)
    user_category_relationship = UserCategoryRelationship(
        social_user = social_user_obj,
    ...
    # 2548674752, @cryptomed 'physician' & 'moderator'
    social_user_obj, created = SocialUser.objects.get_or_create(user_id = 2548674752, social_media = soc_med_obj)
    user_category_relationship = UserCategoryRelationship(
        social_user = social_user_obj,
    ...
    # 966620293707042817, @PharmaTocTocBot 'pharmacist'
    social_user_obj, created = SocialUser.objects.get_or_create(user_id = 966620293707042817, social_media = soc_med_obj)
    user_category_relationship = UserCategoryRelationship(
        social_user = social_user_obj,
