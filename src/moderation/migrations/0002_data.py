...
def create_usercategoryrelationship_instances(apps, schema_editor):
    ...
    # 762321963402596352 @freehealthio 'midwife'
    social_user_obj = SocialUser.objects.get_or_create(user_id = 762321963402596352, social_media = soc_med_obj)
    user_category_relationship = UserCategoryRelationship(
        social_user = social_user_obj,
    ...
    # 2567917734, @librehealthcare 'patient'
    social_user_obj = SocialUser.objects.get_or_create(user_id = 2567917734, social_media = soc_med_obj)
    user_category_relationship = UserCategoryRelationship(
        social_user = social_user_obj,
    ...
    # 2548674752, @cryptomed 'physician' & 'moderator'
    social_user_obj = SocialUser.objects.get_or_create(user_id = 2548674752, social_media = soc_med_obj)
    user_category_relationship = UserCategoryRelationship(
        social_user = social_user_obj,
    ...
    # 966620293707042817, @PharmaTocTocBot 'pharmacist'
    social_user_obj = SocialUser.objects.get_or_create(user_id = 966620293707042817, social_media = soc_med_obj)
    user_category_relationship = UserCategoryRelationship(
        social_user = social_user_obj,
