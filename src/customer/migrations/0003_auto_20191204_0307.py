# Generated by Django 2.2.4 on 2019-12-04 02:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('customer', '0002_auto_20191126_1300'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('copper_provider_id', models.PositiveIntegerField(blank=True, null=True, unique=True)),
                ...
                ('invoice_series', models.CharField(blank=True, max_length=255)),
                ('invoice_starting_number', models.PositiveIntegerField(default=1)),
                ('proforma_series', models.CharField(blank=True, max_length=255)),
                ('proforma_starting_number', models.PositiveIntegerField(default=1)),
                ('default_document_state', models.CharField(choices=[('draft', 'Draft'), ('issued', 'Issued'), ('paid', 'Paid'), ('canceled', 'Canceled')], default='draft', max_length=8)),
