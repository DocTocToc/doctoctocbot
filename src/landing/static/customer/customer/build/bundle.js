...
var app = (function (Cookies) {
    ...
    function create_catch_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 132, 4, 4372);
    		},
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 128, 6, 4306);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function getTransaction() {
    		...
    		const res = await fetch(`http://development.doctoctoc.net/financement/api/projectinvestment/`, config);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { option: 1 });
