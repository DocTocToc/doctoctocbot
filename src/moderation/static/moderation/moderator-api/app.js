...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! svelte/shared.js */ \"./node_modules/svelte/shared.js\");\n/* src/components/App.svelte generated by Svelte v1.64.1 */\n\n\nvar Cookies = __webpack_require__(/*! js-cookie */ \"./node_modules/js-cookie/src/js.cookie.js\");\nvar csrftoken = Cookies.get('csrftoken');\nconsole.log(`csrttoken:${csrftoken}`)\n\n//const socialuserid = document.getElementById('socialuserid').innerHTML;\n//console.log(`socialuserid:${socialuserid}`)\n\n\n/*/ async data fetching function\nconst fetchModeratorId = async () => {\n  const response = await fetch(`${window.location.origin}/moderation/api/moderator-id/`);\n  const json = await response.json();\n  //const jsn = json;\n  const socialuserid = json.id;\n  console.log(`socialuserid * :${json}`)\n};*/\n\nasync function getModeratorId() \n{\n  let response = await fetch(`${window.location.origin}/moderation/api/moderator-id/`);\n  let data = await response.json()\n  let id =  data.id;\n  return id;\n}\n\ngetModeratorId()\n  .then(id => console.log(`moderator id: ${id}`))\n\n// async data fetching function\nconst fetchModerator = async (data, component) => {\n  const id = await getModeratorId();\n  const response = await fetch(`${window.location.origin}/moderation/api/moderators/${id}/`);\n  const json = await response.json();\n  const jsn = json;\n  console.log(jsn);\n  component.set({ jsn });\n};\n\n\nconst patchModerator = async (data) => {\n\t  const id = await getModeratorId();\n\t  const url = `${window.location.origin}/moderation/api/moderators/${id}/`;\n\t  var active = document.getElementById(\"activeswitch\").checked;\n\t  var _public = document.getElementById(\"publicprivateswitch\").checked;\n\t  \n\t  const body = {'active': active, 'public': _public};\n\t  console.log(body);\n\t  try {\n\t\t    const config = {\n\t\t        method: 'PATCH',\n\t\t        headers: {\n\t\t            'Accept': 'application/json',\n\t\t            'Content-Type': 'application/json',\n\t\t            'X-CSRFToken': `${csrftoken}`,\n\t\t        },\n\t\t        body: JSON.stringify(body)\n\t\t    }\n\t\t    const response = await fetch(url, config)\n\t\t    const json = await response.json()\n\t\t    if (response.ok) {\n\t\t        console.log(json)\n\t\t        return response\n\t\t    } else {\n\t\t        //\n\t\t    }\n\t\t} catch (error) {\n\t\t        //\n\t\t}\n\t};\n\n// export the default object\nvar methods = {\n\n  patch() {\n\t    let data = this.get();\n    patchModerator(data, this);\n  },\n};\n\nfunction oncreate() {\n  let data = this.get();\n  fetchModerator(data, this);\n};\n\nfunction add_css() {\n\tvar style = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"style\");\n\tstyle.id = 'svelte-12z4ikv-style';\n\tstyle.textContent = \".onoffswitch.svelte-12z4ikv{position:relative;width:90px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none}.publicprivateswitch.svelte-12z4ikv{position:relative;width:100px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none}.onoffswitch-checkbox.svelte-12z4ikv{display:none}.onoffswitch-label.svelte-12z4ikv{display:block;overflow:hidden;cursor:pointer;border:2px solid #999999;border-radius:20px}.onoffswitch-inner.svelte-12z4ikv{display:block;width:200%;margin-left:-100%;transition:margin 0.3s ease-in 0s}.onoffswitch-inner.svelte-12z4ikv:before,.onoffswitch-inner.svelte-12z4ikv:after{display:block;float:left;width:50%;height:30px;padding:0;line-height:30px;font-size:14px;color:white;font-family:Trebuchet, Arial, sans-serif;font-weight:bold;box-sizing:border-box}.onoffswitch-inner.svelte-12z4ikv:before{content:\\\"ON\\\";padding-left:10px;background-color:#34A7C1;color:#FFFFFF}.publicprivateswitch-inner.svelte-12z4ikv:before{content:\\\"PUBLIC\\\";padding-left:10px;background-color:#34A7C1;color:#FFFFFF}.onoffswitch-inner.svelte-12z4ikv:after{content:\\\"OFF\\\";padding-right:10px;background-color:#EEEEEE;color:#999999;text-align:right}.publicprivateswitch-inner.svelte-12z4ikv:after{content:\\\"PRIVATE\\\";padding-right:10px;background-color:#EEEEEE;color:#999999;text-align:right}.onoffswitch-switch.svelte-12z4ikv{display:block;width:18px;margin:6px;background:#FFFFFF;position:absolute;top:0;bottom:0;right:56px;border:2px solid #999999;border-radius:20px;transition:all 0.3s ease-in 0s}.publicprivateswitch-switch.svelte-12z4ikv{display:block;width:18px;margin:6px;background:#FFFFFF;position:absolute;top:0;bottom:0;right:66px;border:2px solid #999999;border-radius:20px;transition:all 0.3s ease-in 0s}.onoffswitch-checkbox:checked+.onoffswitch-label.svelte-12z4ikv .onoffswitch-inner.svelte-12z4ikv{margin-left:0}.onoffswitch-checkbox:checked+.onoffswitch-label.svelte-12z4ikv .onoffswitch-switch.svelte-12z4ikv{right:0px}\";\n\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(style, document.head);\n}\n\nfunction create_main_fragment(component, state) {\n\tvar div;\n\n\tfunction select_block_type(state) {\n\t\tif ((state.jsn == null)) return create_if_block;\n\t\treturn create_if_block_1;\n\t}\n\n\tvar current_block_type = select_block_type(state);\n\tvar if_block = current_block_type(component, state);\n\n\treturn {\n\t\tc: function create() {\n\t\t\tdiv = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"div\");\n\t\t\tif_block.c();\n\t\t\tthis.h();\n\t\t},\n\n\t\th: function hydrate() {\n\t\t\tdiv.id = \"app\";\n\t\t},\n\n\t\tm: function mount(target, anchor) {\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"insertNode\"])(div, target, anchor);\n\t\t\tif_block.m(div, null);\n\t\t},\n\n\t\tp: function update(changed, state) {\n\t\t\tif (current_block_type === (current_block_type = select_block_type(state)) && if_block) {\n\t\t\t\tif_block.p(changed, state);\n\t\t\t} else {\n\t\t\t\tif_block.u();\n\t\t\t\tif_block.d();\n\t\t\t\tif_block = current_block_type(component, state);\n\t\t\t\tif_block.c();\n\t\t\t\tif_block.m(div, null);\n\t\t\t}\n\t\t},\n\n\t\tu: function unmount() {\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"detachNode\"])(div);\n\t\t\tif_block.u();\n\t\t},\n\n\t\td: function destroy() {\n\t\t\tif_block.d();\n\t\t}\n\t};\n}\n\n// (2:2) {{#if (jsn == null)}}\nfunction create_if_block(component, state) {\n\tvar p;\n\n\treturn {\n\t\tc: function create() {\n\t\t\tp = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"p\");\n\t\t\tp.textContent = \"Data loading...\";\n\t\t},\n\n\t\tm: function mount(target, anchor) {\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"insertNode\"])(p, target, anchor);\n\t\t},\n\n\t\tp: svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"noop\"],\n\n\t\tu: function unmount() {\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"detachNode\"])(p);\n\t\t},\n\n\t\td: svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"noop\"]\n\t};\n}\n\n// (4:6) {{else}}\nfunction create_if_block_1(component, state) {\n\tvar div, div_1, input, input_checked_value, text, label, text_4, div_2, input_1, input_1_checked_value, text_5, label_1;\n\n\tfunction change_handler(event) {\n\t\tcomponent.patch();\n\t}\n\n\tfunction change_handler_1(event) {\n\t\tcomponent.patch();\n\t}\n\n\treturn {\n\t\tc: function create() {\n\t\t\tdiv = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"div\");\n\t\t\tdiv_1 = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"div\");\n\t\t\tinput = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"input\");\n\t\t\ttext = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createText\"])(\"\\n        \");\n\t\t\tlabel = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"label\");\n\t\t\tlabel.innerHTML = \"<span class=\\\"onoffswitch-inner svelte-12z4ikv\\\"></span>\\n            <span class=\\\"onoffswitch-switch svelte-12z4ikv\\\"></span>\";\n\t\t\ttext_4 = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createText\"])(\"\\n    \");\n\t\t\tdiv_2 = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"div\");\n\t\t\tinput_1 = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"input\");\n\t\t\ttext_5 = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createText\"])(\"\\n        \");\n\t\t\tlabel_1 = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])(\"label\");\n\t\t\tlabel_1.innerHTML = \"<span class=\\\"onoffswitch-inner publicprivateswitch-inner svelte-12z4ikv\\\"></span>\\n            <span class=\\\"onoffswitch-switch publicprivateswitch-switch svelte-12z4ikv\\\"></span>\";\n\t\t\tthis.h();\n\t\t},\n\n\t\th: function hydrate() {\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"addListener\"])(input, \"change\", change_handler);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"setAttribute\"])(input, \"type\", \"checkbox\");\n\t\t\tinput.name = \"onoffswitch\";\n\t\t\tinput.className = \"onoffswitch-checkbox svelte-12z4ikv\";\n\t\t\tinput.id = \"activeswitch\";\n\t\t\tinput.checked = input_checked_value = state.jsn.active;\n\t\t\tlabel.className = \"onoffswitch-label svelte-12z4ikv\";\n\t\t\tlabel.htmlFor = \"activeswitch\";\n\t\t\tdiv_1.className = \"onoffswitch svelte-12z4ikv\";\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"addListener\"])(input_1, \"change\", change_handler_1);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"setAttribute\"])(input_1, \"type\", \"checkbox\");\n\t\t\tinput_1.name = \"onoffswitch\";\n\t\t\tinput_1.className = \"onoffswitch-checkbox svelte-12z4ikv\";\n\t\t\tinput_1.id = \"publicprivateswitch\";\n\t\t\tinput_1.checked = input_1_checked_value = state.jsn.public;\n\t\t\tlabel_1.className = \"onoffswitch-label svelte-12z4ikv\";\n\t\t\tlabel_1.htmlFor = \"publicprivateswitch\";\n\t\t\tdiv_2.className = \"onoffswitch publicprivateswitch svelte-12z4ikv\";\n\t\t},\n\n\t\tm: function mount(target, anchor) {\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"insertNode\"])(div, target, anchor);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(div_1, div);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(input, div_1);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(text, div_1);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(label, div_1);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(text_4, div);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(div_2, div);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(input_1, div_2);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(text_5, div_2);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"appendNode\"])(label_1, div_2);\n\t\t},\n\n\t\tp: function update(changed, state) {\n\t\t\tif ((changed.jsn) && input_checked_value !== (input_checked_value = state.jsn.active)) {\n\t\t\t\tinput.checked = input_checked_value;\n\t\t\t}\n\n\t\t\tif ((changed.jsn) && input_1_checked_value !== (input_1_checked_value = state.jsn.public)) {\n\t\t\t\tinput_1.checked = input_1_checked_value;\n\t\t\t}\n\t\t},\n\n\t\tu: function unmount() {\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"detachNode\"])(div);\n\t\t},\n\n\t\td: function destroy() {\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"removeListener\"])(input, \"change\", change_handler);\n\t\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"removeListener\"])(input_1, \"change\", change_handler_1);\n\t\t}\n\t};\n}\n\nfunction App(options) {\n\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"init\"])(this, options);\n\tthis._state = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"assign\"])({}, options.data);\n\n\tif (!document.getElementById(\"svelte-12z4ikv-style\")) add_css();\n\n\tvar self = this;\n\tvar _oncreate = function() {\n\t\tvar changed = { jsn: 1 };\n\t\toncreate.call(self);\n\t\tself.fire(\"update\", { changed: changed, current: self._state });\n\t};\n\n\tif (!options.root) {\n\t\tthis._oncreate = [];\n\t}\n\n\tthis._fragment = create_main_fragment(this, this._state);\n\n\tthis.root._oncreate.push(_oncreate);\n\n\tif (options.target) {\n\t\tthis._fragment.c();\n\t\tthis._mount(options.target, options.anchor);\n\n\t\tObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"callAll\"])(this._oncreate);\n\t}\n}\n\nObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"assign\"])(App.prototype, svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"proto\"]);\nObject(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__[\"assign\"])(App.prototype, methods);\n/* harmony default export */ __webpack_exports__[\"default\"] = (App);\n\n//# sourceURL=webpack:///./src/components/App.svelte?");
...
"use strict";
eval("\n\nvar _App = __webpack_require__(/*! ./components/App.svelte */ \"./src/components/App.svelte\");\n\nvar _App2 = _interopRequireDefault(_App);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar app = new _App2.default({\n  target: document.querySelector('main'),\n  data: {\n    quotes: []\n  }\n});\n\n//# sourceURL=webpack:///./src/index.js?");
